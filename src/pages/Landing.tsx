        ...
        <div className="text-center max-w-2xl mx-auto p-2 px-4 tracking-wide">
            ...
            <div className=' mt-20 text-left space-y-9 mb-24'>
                ...
                <div>
                    ...
                    <p>此系統採用 MIT 協議開源，詳細規範請見 Github 儲存庫<a className=' decoration-accent-li underline underline-offset-2' href="https://github.com/jx06T/time-and-attendance-system">儲存庫連結</a></p>
                </div>
                <div>
